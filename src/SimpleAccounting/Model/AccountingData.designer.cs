// ------------------------------------------------------------------------------
//  <auto-generated>
//    Generated by Open Xsd2Code. Version 3.4.2.33629 MIT License (MIT) 
//    <NameSpace>lg2de.SimpleAccounting.Model</NameSpace><Collection>List</Collection><codeType>CSharp</codeType><GenerateSeparateFiles>False</GenerateSeparateFiles><OutputFilePath>AccountingData.designer.cs</OutputFilePath><EnableDataBinding>False</EnableDataBinding><EnableLazyLoading>False</EnableLazyLoading><HidePrivateFieldInIDE>False</HidePrivateFieldInIDE><EnableSummaryComment>False</EnableSummaryComment><TrackingChangesEnable>False</TrackingChangesEnable><GenTrackingClasses>False</GenTrackingClasses><VirtualProp>False</VirtualProp><IncludeSerializeMethod>True</IncludeSerializeMethod><EnableEncoding>False</EnableEncoding><Encoder>UTF8</Encoder><UseBaseClass>False</UseBaseClass><BaseClassName>EntityBase</BaseClassName><GenBaseClass>False</GenBaseClass><GenerateCloneMethod>False</GenerateCloneMethod><GenerateDataContracts>False</GenerateDataContracts><CodeBaseTag>Net40</CodeBaseTag><SerializeMethodName>Serialize</SerializeMethodName><DeserializeMethodName>Deserialize</DeserializeMethodName><SaveToFileMethodName>SaveToFile</SaveToFileMethodName><LoadFromFileMethodName>LoadFromFile</LoadFromFileMethodName><GenerateXMLAttributes>True</GenerateXMLAttributes><OrderXMLAttrib>False</OrderXMLAttrib><AutomaticProperties>False</AutomaticProperties><GenerateShouldSerialize>False</GenerateShouldSerialize><DisableDebug>False</DisableDebug><PropNameSpecified>Default</PropNameSpecified><ExcludeIncludedTypes>False</ExcludeIncludedTypes><EnableInitializeFields>False</EnableInitializeFields>
//  </auto-generated>
// ------------------------------------------------------------------------------
namespace lg2de.SimpleAccounting.Model {
    ...
    public partial class AccountingDataSetup {
        ...
        private AccountingDataSetupBehavior behaviorField;
        ...
        public AccountingDataSetupBehavior Behavior {
            get {
    ...
    public partial class AccountingDataSetupBehavior {
        ...
        private string lastBookingImportFolderField;
        
        private string openingTextPatternField;
        
        private ulong lastCarryForwardField;
        
        private bool lastCarryForwardFieldSpecified;
        
        private static System.Xml.Serialization.XmlSerializer serializer;
        
        public string LastBookingImportFolder {
            get {
                return this.lastBookingImportFolderField;
            }
            set {
                this.lastBookingImportFolderField = value;
            }
        }
        
        public string OpeningTextPattern {
            get {
                return this.openingTextPatternField;
            }
            set {
                this.openingTextPatternField = value;
            }
        }
        
        public ulong LastCarryForward {
            get {
                return this.lastCarryForwardField;
            }
            set {
                this.lastCarryForwardField = value;
            }
        }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool LastCarryForwardSpecified {
            get {
                return this.lastCarryForwardFieldSpecified;
            }
            set {
                this.lastCarryForwardFieldSpecified = value;
            }
        }
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(AccountingDataSetupBehavior));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current AccountingDataSetupBehavior object into an XML document
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize() {
            System.IO.StreamReader streamReader = null;
        ...
        /// <summary>
        /// Deserializes workflow markup into an AccountingDataSetupBehavior object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output AccountingDataSetupBehavior object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out AccountingDataSetupBehavior obj, out System.Exception exception) {
            exception = null;
            obj = default(AccountingDataSetupBehavior);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out AccountingDataSetupBehavior obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static AccountingDataSetupBehavior Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((AccountingDataSetupBehavior)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
                if ((stringReader != null)) {
                    stringReader.Dispose();
        ...
        /// <summary>
        /// Serializes current AccountingDataSetupBehavior object into file
        /// </summary>
        /// <param name="fileName">full path of output XML file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes XML markup from file into an AccountingDataSetupBehavior object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output AccountingDataSetupBehavior object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out AccountingDataSetupBehavior obj, out System.Exception exception) {
            exception = null;
            obj = default(AccountingDataSetupBehavior);
            try {
                obj = LoadFromFile(fileName);
        ...
        public static bool LoadFromFile(string fileName, out AccountingDataSetupBehavior obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static AccountingDataSetupBehavior LoadFromFile(string fileName) {
            System.IO.FileStream file = null;
            System.IO.StreamReader sr = null;
            try {
                file = new System.IO.FileStream(fileName, FileMode.Open, FileAccess.Read);
